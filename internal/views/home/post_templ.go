...
func Post(postData PostData) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div x-data=\"{\n            slide: 0,\n        }\" class=\"w-full rounded-none card mb-2 p-4 text-base-content\"><div x-data=\"{\n				scrollLeft: () =&gt; {\n					$el.scrollLeft -= $el.offsetWidth;\n\n				},\n				scrollRight: () =&gt; {\n					$el.scrollLeft += $el.offsetWidth;\n				},\n                onScroll : () =&gt; {\n                    slide = Math.floor($el.scrollLeft / $el.offsetWidth);\n                }\n			}\" x-init=\"onScroll()\" x-on:scroll=\"onScroll()\" class=\"lg:h-[35vw] h-[85vw] lg:w-[35vw] w-[85vw] mx-auto carousel carousel-center space-x-2 rounded-lg bg-transparent\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/home/post.templ`, Line: 102, Col: 73}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/home/post.templ`, Line: 103, Col: 21}
		}
